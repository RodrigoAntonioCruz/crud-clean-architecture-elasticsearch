...
public class PageUtils {
    ...
    public static <T, D> Page<D> toPage(List<T> items, Pageable pageable, long totalElements, Function<T, D> dtoClass, String orderBy, Class<D> dtoClassType) {
        ...
        try {
            ...
            comparator = (o1, o2) -> {
                try {
                    ...
                    throw new RuntimeException("Failed to invoke getter method", e);
                }
            };
